# Exercicio 1
print("Utilize o interpretador para efectuar os seguintes cálculos:")
print(45 + 27)
print(2**3)
print(9 % 4)
print("2" + "34")
...
print("Repita a instrução anterior seguida de duas quebras de linha.")
print("\t\tPrimeira Frase em Python")

print("Obtenha o seguinte resultado com uma única instrução:")
print("Python Menu\n\t1. Primeira linha\n\t2. Segunda\n\t3. Última linha")
